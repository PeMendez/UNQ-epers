...
class VectorServiceImplTest {
    ...
    fun setUp() {
        ...
        ubicacion1 = ubicacionServiceImpl.crearUbicacion("ubicacion1", GeoJsonPoint(8.1, 8.1))
        ubicacion2 = ubicacionServiceImpl.crearUbicacion("ubicacion2", GeoJsonPoint(8.2, 8.0))
