...
class EstadisticaServiceImplTest {
    ...
    fun unaEspecieEsEspecieLiderInfectandoPersonas() {
        ...
        val unVector = vectorServiceImpl.crearVector(TipoDeVector.Persona, paraguay.id!!, false)
    ...
    fun lideresQueInfectaronLaMayorCantidadDeHumanosYAnimales() {
        ...
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion1.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion3.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Animal, ubicacion4.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Animal, ubicacion5.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion6.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion7.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion8.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion9.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion10.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion11.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacion12.id!!, false)
        ...
        val mechaVector = vectorServiceImpl.crearVector(TipoDeVector.Persona,ubicacion2.id!!, false)
        val roboVector = vectorServiceImpl.crearVector(TipoDeVector.Persona,ubicacion2.id!!, false)
        val mechaVectorPlus = vectorServiceImpl.crearVector(TipoDeVector.Persona,ubicacion2.id!!, false)
        val roboVectorAdvanced = vectorServiceImpl.crearVector(TipoDeVector.Persona,ubicacion2.id!!, false)
