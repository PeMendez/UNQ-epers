...
class EspecieServiceImplTest {
    ...
    fun seRecuperaUnaEspecieConTodosSusDatosCorrectos() {
        ...
        vectorServiceImpl.crearVector(TipoDeVector.Persona, ubicacionCreada.id!!, false)
    ...
    fun seConoceLaEspecieLiderConMayorCantidadDePersonasInfectadasCorrectamente() {
        ...
        val ubicacionCreada2 = ubicacionService.crearUbicacion("otroNombre", GeoJsonPoint(8.1, 8.1))
        val vectorInsectoCreado = vectorServiceImpl.crearVector(TipoDeVector.Insecto, ubicacionCreada2.id!!, false)
        vectorServiceImpl.crearVector(TipoDeVector.Animal, ubicacionCreada2.id!!, false)
    ...
    fun alHaberSoloEspeciesConInfectadosNoPersonasEntoncesNoHayEspecieLider() {
        ...
        val patogeno2 = Patogeno("otroNombre")
        val patogenoCreado2 = patogenoService.crearPatogeno(patogeno2)
        val ubicacionCreada2 = ubicacionService.crearUbicacion("otroNombreDeUbicacion", GeoJsonPoint(8.1, 8.1))
        vectorServiceImpl.crearVector(TipoDeVector.Insecto, ubicacionCreada2.id!!, false)
    ...
    fun siUnaEspecieSoloTieneInfectadosInsectosNoFormaParteDelResultadoFinal() {
        ...
        val patogeno2 = Patogeno("otroNombre")
        val patogenoCreado2 = patogenoService.crearPatogeno(patogeno2)
        val ubicacionCreada2 = ubicacionService.crearUbicacion("otroNombreDeUbicacion", GeoJsonPoint(8.0, 8.1))
        vectorServiceImpl.crearVector(TipoDeVector.Insecto, ubicacionCreada2.id!!, false)
